...
namespace linearTask
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int xMin = -9;
            int xMax = 6;
            int roundDecimals = 1; // до скільки знаків округлювати y
            int pointsNumber = 10;

            int minPercentForScatterY = 90;
            int maxPercentForScatterY = 110;

            /// y = ax1 +bx2 + c
            double aCoefficient = 2;
            double bCoefficient = 4;
            double cCoefficient = -2;
